...
const EXPECTING_FILE_ERROR =
  'Expecting either a private key or a mnemonic file. Refer to the README file for more details.'
      ...
      provider: function () {
        ...
        if (fs.existsSync(privateKeyPath)) {
          const privateKey = readFileSync(
            path.join(__dirname, 'rinkeby_private_key'),
            'utf-8',
          )
